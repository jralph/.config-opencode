...
The principle: **elevated surfaces need visual distinction from what's beneath them.**
...
**The test:** Squint at your interface. You should still perceive the hierarchy — what's above what, where sections divide. But no single border or surface should jump out at you.

If borders are the first thing you notice, they're too strong. If you can't find where one region ends and another begins, they're too subtle.
...
The key is having a system: small radius for inputs and buttons, medium for cards, large for modals or containers.
...
Icons next to text should align optically, not mathematically.
...
Use smooth deceleration easing (ease-out variants).
