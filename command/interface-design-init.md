...
Before writing any code, the files above contain the foundation, principles, craft knowledge, and checks.

Do not skip these. The craft knowledge is in these files.
